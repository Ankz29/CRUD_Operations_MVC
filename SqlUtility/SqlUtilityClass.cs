...
namespace CRUD_Operations_Using_EF.SqlUtility
{
    public static class SqlUtilityClass
    {
       public static string ConnectionString = ConfigurationManager.ConnectionStrings["myConnectionString"].ToString();
        ...
        {
            string InsertQuery = "INSERT INTO Student_TB (Id, Name, Email, City) VALUES ('" + modelData.ID + "','" + modelData.NAME + "','" + modelData.EMAIL + "','" + modelData.CITY + "','"+modelData.PHONENUMBER+"')";
            try
            {
        ...
        {
            string UpdateQuery = "UPDATE Student_TB SET Id='" + modelData.ID + "', Name='" + modelData.NAME + "', Email='" + modelData.EMAIL + "', City='" + modelData.CITY + "',PhoneNumber='" + modelData.PHONENUMBER + "'";
            try
            {
                using (SqlConnection connection = new SqlConnection(ConnectionString))
                {
